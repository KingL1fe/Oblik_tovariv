...
namespace InventoryApp {
    ...
    public ref class AddEditSupplierForm : public System::Windows::Forms::Form
    {
    public:
        AddEditSupplierForm(int id)
        {
            InitializeComponent();
            this->SupplierId = id;
        ...
        property String^ SupplierContactInfo {
...
#pragma region Windows Form Designer generated code
        void InitializeComponent(void)
        {
            ...
            this->Name = L"AddEditSupplierForm";
